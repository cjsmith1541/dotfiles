...
-- Neotree keybinds
map("n", "<TAB>", ":Neotree filesystem toggle left <CR>", {})
...
-- Neorg keybinds
map('n', '<leader>e', [[:Neorg keybind all core.looking-glass.magnify-code-block <CR>]], noremap, { desc = "Paste from outside nvim"})
