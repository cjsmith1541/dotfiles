...
awful.keyboard.append_global_keybindings(
{
    ...
    function()
        ...
        function(_, key, event)
            ...
            elseif key == "2" then
                awful.util.spawn(apps.browser)     -- TAG 2
            elseif key == "3" then
                awful.util.spawn(apps.chat)        -- TAG 3
            elseif key == "4" then
                awful.util.spawn(apps.game)        -- TAG 4
            elseif key == "5" then
                awful.util.spawn(apps.game1)       -- TAG 5
            elseif key == "6" then
                awful.util.spawn(apps.music)       -- TAG 6
            elseif key == "7" then
                awful.util.spawn(apps.movieplayer) -- TAG 7
            elseif key == "8" then
                awful.util.spawn(apps.file)        -- TAG 8
            elseif key == "9" then
                awful.util.spawn(apps.noteapp)     -- TAG 9
            end
